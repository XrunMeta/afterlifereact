...
def _idle_kwargs(idle_opts: dict | None) -> dict:
    ...
    keys = ("idle_motion_scale", "idle_rms_low", "idle_rms_high", "head_slew_frames",
            ...
            "head_sway_slow", "source_face_lock_full")
...
def _parse_render_body(raw: bytes) -> tuple[str, str, Optional[object], dict, dict]:
    ...
    render_opts = {
        ...
        # blink_interval_sec/head_yaw_offset/head_pitch_offset). 키 없으면 None →
        # stream_wav_frames가 no-op/기존 기본 사용(회귀 0).
        ...
        "source_face_lock_full": req.get("source_face_lock_full"),
