...
const FeedCard: React.FC<FeedCardProps> = ({
  ...
  const [profileRowH, setProfileRowH] = React.useState(0);
  return (
        ...
        <>
          ...
          <View
            style={[
              styles.rightActions,
              bottomContentH > 0 && {
                bottom: (isOwn ? bottomContentH - profileRowH : bottomContentH) + 16,
              },
            ]}
          >
            {}
          ...
          >
            <View
              ...
              onLayout={(e) => setProfileRowH(e.nativeEvent.layout.height)}
            >
